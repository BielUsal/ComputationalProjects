      ...
      integer:: i, n
      h=0.1d0
      call RK4(t,y,h,0.0d0,0.0d0,1.0d0,20.d0,n)
      call MakeFiles("sol1",t,y,n)

      call RK4(t,y,h,0.0d0,0.0d0,1.5d0,20.d0,n)
      call MakeFiles("sol2",t,y,n)
      
      call RK4(t,y,h,0.0d0,0.0d0,1.999999d0,60
      .d0,n)
      call MakeFiles("sol3",t,y,n)
      
      call RK4(t,y,h,0.0d0,0.0d0,2.5d0,20.d0,n)
      call MakeFiles("sol4",t,y,n)
      
      call RK4(t,y,h,0.0d0,0.0d0,3.0d0,20.d0,n)
      call MakeFiles("sol5",t,y,n)

      call RK4(t,y,h,0.1d0,0.0d0,2d0,50.d0,n)
      call MakeFiles("sol6",t,y,n)
      
      call RK4(t,y,h,0.1d0,0.0d0,2.5d0,50.d0,n)
      call MakeFiles("sol7",t,y,n)
      
      call RK4(t,y,h,0.1d0,0.0d0,3.0d0,50.d0,n)
      call MakeFiles("sol8",t,y,n)
...
c    i.e, our diff equation will be: f1 = y2,f2 = -sin(y1) - alpha y2
     ...
     c,alpha)
      ...
      subroutine MakeFiles(name,t,y,n)
      real*8::t,y
      dimension::t(0:1000),y(1:2,0:1000)
      character(len=4)::name
      integer::n
      open(12,file=name//"ty.txt")
      open(13,file=name//"vy.txt")
      do i=0,n
        write(12,*) t(i),y(1,i)
        write(13,*) y(1,i),y(2,i)
      end do
      end subroutine
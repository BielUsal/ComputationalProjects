      ...
      h=0.1d0
      n=20.d0/h
      call RK4(t,y,h,0.0d0,0.0d0,1.0d0)
      ...
      subroutine RK4(t,y,h,alpha,y0,v0)
      implicit none
      real*8::t,y,h,f1,f2,K,alpha,y0,v0
...
c    i.e, our diff equation will be: f1 = y2,f2 = -sin(y1) - alpha y2
     ...
     c,alpha)
      ...
      y(1,i) = y(1,i) +(h/6)*(K(1,1)+2*K(1,2)+2*K(1,3)+K(1,4)) 
      y(2,i) = y(2,i) +(h/6)*(K(2,1)+2*K(2,2)+2*K(2,3)+K(2,4)) 
      end do
      end subroutine

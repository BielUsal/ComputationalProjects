...
begin
	...
	Per = @bind Np NumberField(0:100,default=10)
		md"""
For physical parameters of the simulation, we only need the length of the well $$d_w =$$ $DW A and the number of periods $$Np=$$ $Per
"""
end
